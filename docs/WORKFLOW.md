...
|---------|--------|-----------|------------|
| Hero | Column, left-aligned | No explicit max-width (flows in 1400px page container) | Title: `clamp(56px, 9vw, 168px)`, line-height: 0.9 |
| Footer | Grid, 2 columns | 1400px container | `grid-template-columns: minmax(200px, 2fr) 3fr`, gap: 64px |
| Navbar | Flex row, space-between | 1400px container | Gap: 4px between links |
| Countdown | Centered flex row | — | Block min-width: 64px |
| What Is | (TBD Stage 6) | | |
| Program | (TBD Stage 7) | | |
| ... | | | |